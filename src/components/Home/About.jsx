...
const testimonials = [
{
  text: "Supertune Scotland provided an excellent tuning experience — my car feels noticeably more powerful and responsive across the rev range. The team were knowledgeable, friendly, and flexible with booking times. They handled diagnostics, remapping, and performance upgrades professionally, and the results were exactly what I expected. I’d highly recommend them for anyone looking for reliable ECU mapping or performance tuning services!",
  name: "Supertune Scotland Customer",
}
