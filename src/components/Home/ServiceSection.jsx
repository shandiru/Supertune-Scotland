...
const services = [
  {
    ...
    desc: "Enhance your vehicle's power, torque, and responsiveness with professional performance tuning solutions.",
    image: "/performance-tuning.avif",
    path: "/services/performance-tuning",
  },
  {
    title: "EGR Removal",
    desc: "Remove or optimize the Exhaust Gas Recirculation system to improve engine efficiency and prevent clogging.",
    image: "/egr-removal.avif",
    path: "/services/egr-removal",
  },
  {
    title: "AdBlue Delete",
    desc: "AdBlue system removal or modification for smoother performance and reduced maintenance requirements.",
    image: "/adblue-delete.avif",
    path: "/services/adblue-delete",
  },
